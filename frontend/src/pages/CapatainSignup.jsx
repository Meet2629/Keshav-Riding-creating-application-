...
const CapatainSignup = () => {
  ...
  return (
    <>
   <div className='py-5 px-5 h-screen flex-col justify-between'>
   <div>
     <div className='p-7'>
     ...
     <h3 className='text-lg font-medium mb-2'> What's our Captain's name</h3>
      ...
      <input 
        ...
        <h3 className='text-lg font-medium mb-2'> What's our Capatin's email</h3>
        <input 
         required
        ...
        <p className='text-center'>Already have a Account? <Link to='/captain-login' className='text-blue-600 mb-7 '>Login here</Link></p>
       </div>
   </div>
